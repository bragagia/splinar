...
export function mailMondayRecap(
  user: Tables<"users">,
  dupCount: number
): postmark.Message {
  return {
    From: "noreply@splinar.com",
    To: user.email || "",
    Subject: "Splinar - Your Duplicate Report",
...
Or book a call with us here: https://calendly.com/d/ck7p-764-d35/splinar-support
...
<html>
  <head>
    ...
    <meta content="date=no" />
    <meta content="address=no" />
    <meta content="email=no" />
    <meta />
    <link />
    <link />
    <title>Splinar - Your Duplicate Report</title>
    <style>
      @media all {
        /* cyrillic-ext */
        @font-face {
                                          ...
                                          >
                                            <div>
                                              <span
                                                ...
                                                identified duplicates in need of
                                                deletion in your CRM. Follow
                                                this link to access your account
                                                and start merging
                                                duplicates:</span
                                              >
                                            </div>
                                            ...
                                            <div>
                                              ...
                                              ><span
                                                style="
                                                  color: rgb(155, 155, 155);
                                                "
                                                >. Or book a call with us </span
                                              ><a
                                                href="https://calendly.com/d/ck7p-764-d35/splinar-support"
                                                style="
                                                  text-decoration: none;
                                                  color: #9b9b9b;
                                                "
